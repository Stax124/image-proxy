...
| `IMAGE_PROXY_CACHE_STATUS_HEADER`     | `X-Image-Proxy-Cache`                    | Name of the response header indicating cache status (`HIT` or `MISS`). Change to customize the header name (e.g. `X-Cache`)                              |
